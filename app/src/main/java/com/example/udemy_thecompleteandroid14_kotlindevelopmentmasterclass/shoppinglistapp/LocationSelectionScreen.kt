...
@Composable
fun LocationSelectionScreen(location:ShoppingLocationData, onLocationSelected:(ShoppingLocationData) -> Unit){
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        var newLocation:ShoppingLocationData
        Button(onClick = { 
          newLocation = ShoppingLocationData(userLocation.value.latitude, userLocation.value.longitude)
