package com.example.udemy_thecompleteandroid14_kotlindevelopmentmasterclass.happyplaceapp.database
...
class DatabaseHandler(context:Context):SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    fun updateHappyPlace(happyPlace: HappyPlaceModel): Int {
        ...
        db.close() // Closing database connection / Closing database connection
        return success
    }
